...
void main() {
  ...
  group('Only included files - ', () {
    test('Given a single file in the root '
        'when printing the file tree '
        'then that single file is printed', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {'pubspec.yaml'},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given a two files in the root '
        'when printing the file tree '
        'then both files are printed', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {'README.md', 'pubspec.yaml'},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given a two files in unsorted order in the root '
        'when printing the file tree '
...
''');
    ...
    test('Given a file nested in a directory '
        'when printing the file tree '
        'then the path to the file is printed', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {'folder/README.md'},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given multiple files nested in a directory '
        'when printing the file tree '
        'then the path to the files is printed', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {'folder/pubspec.yaml', 'folder/a.md'},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given a file and multiple files nested in a directory in the root '
        'when printing the file tree '
        'then the printed tree includes all paths', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {'README.md', 'folder/pubspec.yaml', 'folder/a.md'},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given nested directory and file structure '
        'when printing the file tree '
        'then the nested directory is printed before the file', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {'root/b/a.dart', 'root/b/b.dart', 'root/a.dart'},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given a platform specific structure format '
        'when printing the file tree '
        'then the structure is printed correctly', () {
      final result = BufferLogger();

      FileTreePrinter.writeFileTree(
        filePaths: {p.join('root', 'b', 'b.dart')},
        ignoredPaths: {},
        write: result.raw,
      );
...
''');
    ...
    test('Given a nested directories with different lengths '
        'when printing the file tree '
...
''');
  ...
  group('Only ignored files - ', () {
    test('Given a single ignored file in the root '
        'when printing the file tree '
...
''');
    ...
    test('Given a two ignored files in the root '
        'when printing the file tree '
      ...
      FileTreePrinter.writeFileTree(
        filePaths: {},
        ignoredPaths: {'README.md', 'pubspec.yaml'},
        write: result.raw,
      );
...
''');
    ...
    test(
      ...
      () {
        ...
        FileTreePrinter.writeFileTree(
          filePaths: {},
          ignoredPaths: {'folder/pubspec.yaml', 'folder/a.md'},
          write: result.raw,
        );
...
''');
    ...
    test(
      ...
      () {
        ...
        FileTreePrinter.writeFileTree(
          filePaths: {},
          ignoredPaths: {'README.md', 'folder/pubspec.yaml', 'folder/a.md'},
          write: result.raw,
        );
...
''');
    ...
    test('Given a platform specific structure format '
      ...
      FileTreePrinter.writeFileTree(
        filePaths: {},
        ignoredPaths: {p.join('root', 'b', 'b.dart')},
        write: result.raw,
      );
...
''');
    ...
    test('Given multiple files in nested structures '
        'when printing the file tree '
