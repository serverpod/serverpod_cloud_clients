...
const _scenarios = [
  ...
  _Scenario('db user list', ['db', 'user', 'list', '--project', _projectId]),
  _Scenario('db user list', [
    'db',
    'user',
    'list',
    '--project',
