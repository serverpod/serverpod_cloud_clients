...
'''),
    ...
    group('and in a parent directory of a serverpod directory', () {
      late Future commandResult;
      ...
      setUp(() async {
        ...
        parentDir = p.join(d.sandbox, 'parent_dir');
        pushCurrentDirectory(parentDir);
      });
      ...
      group('when calling create without --project-dir option', () {
        ...
        test('then does not write scloud.yaml file', () async {
          ...
          final expected = d.dir(parentDir, [
            d.nothing('scloud.yaml'),
            d.dir('server_dir', [
              d.nothing('scloud.yaml'),
            ]),
