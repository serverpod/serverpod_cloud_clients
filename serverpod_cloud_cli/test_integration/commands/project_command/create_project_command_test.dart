...
'''),
      ...
      group('when calling create with --profile option', () {
        ...
        test(
          'then without --profile createProject is called with starter-project',
          () async {
            ...
            verify(
              () => client.projects.createProject(
                ...
                projectProductName: ProjectProductName.starter,
              ),
            ).called(1);
          },
        );
        ...
        test(
          ...
          () async {
            ...
            verify(
              () => client.projects.createProject(
                cloudProjectId: projectId,
                projectProductName: ProjectProductName.growth,
              ),
            ).called(1);
          },
        );
    ...
    group(
      'and inside a dart (but not Serverpod) directory when calling create',
      () {
        late Future commandResult;
    ...
    group('and in a directory 3 levels up from a serverpod directory', () {
      ...
      setUp(() async {
        await d.dir('grandparent_dir', [
          d.dir('parent_dir', [
            d.dir('server_dir', [ProjectFactory.serverpodServerPubspec()]),
          ]),
        ]).create();
