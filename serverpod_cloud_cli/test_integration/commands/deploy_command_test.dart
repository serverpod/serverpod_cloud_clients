...
'''),
  ...
  group(
      'and a workspace directory structure and a valid upload description response',
      () {
    setUp(() async {
...
'''),
  ...
  group(
      'and a workspace directory structure with an indirect flutter dependency',
      () {
    setUp(() async {
      await d.dir('monorepo', [
        d.file('pubspec.yaml', '''
...
'''),
  ...
  group('and a workspace package with missing workspace root', () {
    setUp(() async {
      await d.dir('monorepo', [
        d.dir('packages', [
          d.dir('dart_utilities', [
...
'''),
    ...
    group('when deploying through CLI and with --dry-run', () {
      ...
      test('then missing workspace root error message is logged.', () async {
        await cliCommandFuture.catchError((final _) {});
        ...
        expect(
          ...
          equalsErrorCall(
            message: "Could not find the workspace root directory.",
