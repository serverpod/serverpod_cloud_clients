// Source: https://github.com/dart-lang/pub/blob/e9ad2bc/lib/src/ignore.dart
  ...
  static (Set<String> collectedFiles, Set<String> ignoredFiles) listFiles({
    ...
    while (toVisit.isNotEmpty) {
      ...
      if (currentIsDir) {
        ...
        toVisit
            .add(listDir(normalizedCurrent).map((final x) => '/$x').toList());
        if (includeDirs) {
...
_IgnoreParseResult _parseIgnorePattern(
    final String pattern, final bool ignoreCase) {
