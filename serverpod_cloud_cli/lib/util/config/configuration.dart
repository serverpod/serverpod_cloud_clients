...
/// [valueRequired] is a more permitting version of [mandatory].
/// If true, the options must either have been provided in the configuration sources,
...
class Configuration<T extends OptionDefinition> {
  ...
  String? valueOrNull(final T option) {
    if (!_config.containsKey(option) && _options.contains(option)) {
      ...
      throw InvalidOptionConfigurationException(option,
