...
abstract class EmailMethodBlockedException
  ...
  factory EmailMethodBlockedException({required String message}) =
      _EmailMethodBlockedExceptionImpl;

  factory EmailMethodBlockedException.fromJson(
  ...
  @override
  String toString() {
    return 'EmailMethodBlockedException(message: $message)';
  }
}

class _EmailMethodBlockedExceptionImpl extends EmailMethodBlockedException {
  _EmailMethodBlockedExceptionImpl({required String message})
