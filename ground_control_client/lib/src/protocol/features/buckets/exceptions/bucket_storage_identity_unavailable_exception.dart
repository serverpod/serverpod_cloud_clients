...
abstract class BucketStorageIdentityUnavailableException
  ...
  factory BucketStorageIdentityUnavailableException({required String message}) =
      _BucketStorageIdentityUnavailableExceptionImpl;

  factory BucketStorageIdentityUnavailableException.fromJson(
  ...
  @override
  String toString() {
    return 'BucketStorageIdentityUnavailableException(message: $message)';
  }
}

class _BucketStorageIdentityUnavailableExceptionImpl
    extends BucketStorageIdentityUnavailableException {
  _BucketStorageIdentityUnavailableExceptionImpl({required String message})
