...
class EndpointAdminProjects extends _i1.EndpointRef {
  ...
  _i2.Future<void> changeProjectOwner({
    required String cloudProjectId,
...
class EndpointAdminUsers extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i8.User>> listUsers({
    String? cloudProjectId,
    _i9.UserAccountStatus? ofAccountStatus,
    bool? includeArchived,
  }) => caller.callServerEndpoint<List<_i8.User>>('adminUsers', 'listUsers', {
    'cloudProjectId': cloudProjectId,
  ...
  ///
  /// Throws a [NotFoundException] if the user is not found.
  _i2.Future<_i8.User> getUser({
    required String email,
    bool? includeArchived,
  }) => caller.callServerEndpoint<_i8.User>('adminUsers', 'getUser', {
    'email': email,
    'includeArchived': includeArchived,
  });
...
class EndpointProjects extends _i1.EndpointRef {
  ...
  _i2.Future<void> updateProjectProfile({
    required String cloudProjectId,
    required _i7.ProjectProfileUpdate resources,
...
class EndpointUsers extends _i1.EndpointRef {
  ...
  _i2.Future<_i8.User> readUser() =>
      caller.callServerEndpoint<_i8.User>('users', 'readUser', {});

  /// Updates current user's [name].
  _i2.Future<_i8.User> updateUserName(String name) => caller
      .callServerEndpoint<_i8.User>('users', 'updateUserName', {'name': name});

  /// Reads all users that have a role in the specified project.
  _i2.Future<List<_i8.User>> listUsersInProject({
    required String cloudProjectId,
