...
/// {@category Endpoint}
class EndpointAdminDatabaseScaling extends _isc.EndpointRef {
  EndpointAdminDatabaseScaling(_isc.EndpointCaller caller) : super(caller);
  ...
  _ida.Future<void> reconcileComputeScaling({
    bool? dryRun,
...
class EndpointAdminMigration extends _isc.EndpointRef {
  ...
  _ida.Future<Map<String, String>> backfillSubscriptionUsageFilters() =>
...
class EndpointAdminProjects extends _isc.EndpointRef {
  ...
  /// The result includes the owners for each project
  /// and the latest deploy attempt time (or null if undeployed).
  _ida.Stream<_ie7ffsfx.AdminProjectInfo> listAdminProjectsInfo({
    bool? includeArchived,
    bool? includeLatestDeployAttemptTime,
    bool? includePaymentsStatus,
  }) =>
      caller.callStreamingServerEndpoint<
        _ida.Stream<_ie7ffsfx.AdminProjectInfo>,
        _ie7ffsfx.AdminProjectInfo
  ...
  /// Moves a project to a new subscription under a new owner, with the same
  /// plan type as previously and to the private/business type of the new owner.
  ///
  /// Completes after the project and related resources have been moved.
  ///
  /// Throws [NotFoundException] if the project is not found.
  /// Throws [InvalidValueException] if the new owner is the same as the current owner.
  ...
  /// Throws [ProcurementDeniedException] if the products are not available on the new plan.
  /// Throws [ConcurrentSubscriptionUpdateException] if another update is in progress.
  _ida.Future<void> changeProjectOwner({
    required String cloudProjectId,
    required _isc.UuidValue newOwnerId,
  }) => caller.callServerEndpoint<void>('adminProjects', 'changeProjectOwner', {
    'cloudProjectId': cloudProjectId,
  ...
  ///
  /// When [profile.databaseSize] is null, database sizing is not changed.
  ///
  /// Completes after the project profile and related resources are updated.
  ///
  /// Throws [NotFoundException] if the project is not found.
  ...
  _ida.Future<_isc.UuidValue> reprocureExistingProject({
    required String cloudProjectId,
    required _iag8nc5u.ProjectProfileUpdate profile,
  ...
  _ida.Future<_isc.UuidValue> redeployCapsule(String cloudCapsuleId) =>
      caller.callServerEndpoint<_isc.UuidValue>(
        'adminProjects',
        'redeployCapsule',
...
class EndpointAdminUsers extends _isc.EndpointRef {
  ...
  /// Reads the user with the specified email.
  ///
  /// Throws a [NotFoundException] if the user is not found.
  _ida.Future<_ibu0ogga.User> getUser({
    required String email,
    bool? includeArchived,
  }) => caller.callServerEndpoint<_ibu0ogga.User>('adminUsers', 'getUser', {
    'email': email,
    'includeArchived': includeArchived,
  });
  ...
  /// do not exist.
  _ida.Future<void> attachUser({
    required String cloudProjectId,
    required String email,
    required List<_io9j0but.ProjectRole> assignRoles,
  ...
  _ida.Future<List<String>> detachUser({
    required String cloudProjectId,
    required String email,
    List<_io9j0but.ProjectRole>? unassignRoles,
...
class EndpointAuthWithAuth extends _isc.EndpointRef {
  ...
  _ida.Future<_iacc.AuthSuccess> createCliLoginSession() =>
      caller.callServerEndpoint<_iacc.AuthSuccess>(
        'authWithAuth',
...
class EndpointCustomDomainName extends _isc.EndpointRef {
  ...
  _ida.Future<_i19g777e.DomainNameStatus> refreshRecord({
    required String domainName,
    required String cloudCapsuleId,
  }) => caller.callServerEndpoint<_i19g777e.DomainNameStatus>(
    'customDomainName',
    'refreshRecord',
...
class EndpointProjects extends _isc.EndpointRef {
  ...
  _ida.Future<void> inviteUser({
    required String cloudProjectId,
    required String email,
    List<_io9j0but.ProjectRole>? assignRoles,
